      ...
      <div className="imagesAndDescFlexWrap">
        <div className="productImageWrap">
          <div className="productWrap">
            {" "}
            <img className="clickedProductImages" src={macbookFront}></img>
          </div>
          <div className="productWrap">
          {" "}
            <img className="clickedProductImages" src={ macbookTop }></img> </div>


          <div className="productWrap"> 
          {" "}
            <img className="clickedProductImages" src={ macbookSide }></img>
          </div>
        </div>
        <Button text="See More" />
       <div className="addToCartBtnWrap"> <Button text="Add To Cart" className="addToCartBtn" onClick={e => addToCartClick(laptop)} /></div>
        <div className="descriptionWrap">
            
        <div className="detailsWrap">
      <Button text='Details' className="collapsibleDetailsBtn" onClick={handleOpen} />
      {open ? <div className="detailsBoxOne">A refurbished Macbook Pro 13-Inch. Featuring a 13.3-inch LED-backlit display,
