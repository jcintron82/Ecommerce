...
import top from "../../../images/laptops/macbookair/top.jpg";
import front from "../../../images/laptops/macbookair/front.jpg";
import inuse from "../../../images/laptops/macbookair/inuse.jpg";
...
const liTwo = [
  boldText("STRIKINGLY THIN DESIGN"),
  <br />,
  "The redesigned MacBook Air is more portable than ever and weighs just 2.7 pounds. It’s the ultracapable laptop that lets you work, play, or create just about anything—anywhere.",
];
const liThree = [
  boldText("SUPERCHARGED BY M2"),
  <br />,
 "Get more done faster with a next-generation 8-core CPU, up to 10-core GPU, and up to 24GB of unified memory.",
];
const liFour = [
  boldText("UP TO 18 HOURS OF BATTERY LIFE"),
  <br />,
  "Go all day and into the night, thanks to the power-efficient performance of the Apple M2 chip/",
];
const liFive = [
  boldText("BIG, BEAUTIFUL DISPLAY"),
  <br />,
  "The 13.6-inch Liquid Retina display features over 500 nits of brightness, P3 wide color, and support for one billion colors for vibrant images and incredible detail.",
];
...
export function MacbookAir() {
  const imageGallery = [top, front, inuse];
  ...
  const product = {
    name: 'MacBook Air 13.6" Laptop - Apple M2 chip - 8GB Memory - 256GB SSD (Latest Model) - Midnight',
    price: 1020.00.toFixed(2),
          ...
          <div className="productNameHeader">
            ...
            <div className="pricesWrapParent">
              ...
              <div className="savedPriceWrap">
                <strike className="strikedPrice">$1,190</strike> Save $170.00!
              </div>
            </div>
          </div>
        </div>
